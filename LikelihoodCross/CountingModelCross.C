...
void CountingModelCross(  int nobs_4m = 27,           // number of observed events
  ...
  
{
  ...
  w.factory("prod:s_4m(cross[14700,0.,10000000],BR_4m[0.5,0,1],Acc_4m[0.5,0.,1.],Lumi[2.229,0.,10000])");  
  w.factory("prod:s_2e2m(cross[14700,0.,10000000],BR_2e2m[0.5,0,1],Acc_2e2m[0.5,0.,1.],Lumi[2.229,0.,10000])");  
  w.factory("prod:s_4e(cross[14700,0.,10000000],BR_4e[0.5,0,1],Acc_4e[0.5,0.,1.],Lumi[2.229,0.,10000])");  
  ...
  //  std::cout<<"Cross "<<mc.GetParametersOfInterest()->getRealValue("cross")*BR_4m<<std::endl;
